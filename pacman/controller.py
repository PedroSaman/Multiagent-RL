...
class Controller(object):
    ...
    def __send_agent_action__(self, msg):
        ...
        self.realPositions = msg.agent_positions
    ...
    def __set_agent_pm_eqm__(self, msg):
        ...
        if len(self.probability_map) == len(self.__get_allies__(ident))+1:
            ...
            self.numInstances += 1
            pacman_pos = self.realPositions[pacman[0]]
            ...
            self.instanceError += self.game_states[0].calculate_distance((maxValueX, maxValueY), pacman_pos)
            print("New Instance Error: {}".format(self.game_states[0].calculate_distance((maxValueX, maxValueY), pacman_pos)))
    ...
    def __set_mse__(self, msg):
        ...
        print("\nNumero instancia: {}".format(self.numInstancesArray[msg.agent_id-1]))
